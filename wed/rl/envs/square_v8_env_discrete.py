# This file contains the environment used in Section 4.16 containing hierarchicaly placed rectangles based on real screenshots with discrete actions
import random
import gymnasium
...
from wed.cv.simple_detector import find_bounding_boxes
...
class SquareEnv(gymnasium.Env):
    ...
    def __init__(self, height: int = 100, width: int = 100, render_mode=None, dataset_folder: str = r"rl\dataset_big", start_rects: int = 3, name: str = "env", state_type=ObservationType.STATE_IMAGE_ONLY, padding: float = 0.05) -> None:
        super().__init__()
...
if __name__ == "__main__":
    env = gymnasium.make('square-v8-discrete', render_mode='human', height=84, width=84, start_rects=1000)
